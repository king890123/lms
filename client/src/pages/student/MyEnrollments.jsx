...
const MyEnrollments = () => {
  const {enrolledCourses,fetchUserEnrolledCourses,calculateCourseDuration,navigate,userData,backendUrl,getToken,calculateNumberOfLectures}=useContext(AppContext)
