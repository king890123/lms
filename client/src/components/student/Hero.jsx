...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center w-full md:pt-36 pt-20 px-7 md:px-0 space-y-7 bg-gradient-to-b from-cyan-100/70'>
      ...
      <p className='md:block hidden text-gray-500 max-w-3xl mx-auto'>
